...
//
class CORE_API FUnknown GNU_VTABLE_FIX
{
public:
...
// Register a class at startup time.
	...
	#define IMPLEMENT_CLASS(TClass) \
		...
		DLL_EXPORT UClass* autoclass##TClass; \
...
public:
	...
	// Destructors.
//	virtual ~UObject();
	VIRTUAL_DESTRUCTOR(UObject);
	void operator delete( void* Object, size_t Size )
		{guard(UObject::operator delete); UOBJECT_DESTRUCT appFree( Object ); unguard;}
	...
	// UObject interface. //All imports are needed in order to build a VTable
