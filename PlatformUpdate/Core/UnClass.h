...
//
class CORE_API UField : public UObject //Size = 52
{
	...
	// Variables.
	UField*			SuperField; //O=40
	UField*			Next; //O=44
	UField*			HashNext; //O=48
...
//
class CORE_API UStruct : public UField // Size = 112
{
...
//
class CORE_API UState : public UStruct //Size = 1160
{
...
// An object class.
//
class CORE_API UClass : public UState //Size = 1272
{
	...
	TArray<BYTE>		Defaults; //O=1240
	void(*ClassConstructor)(void*); //O=1252
	void(UObject::*ClassStaticConstructor)(); // O=1256

	// In memory only.
	FString				DefaultPropText; // O=1260
