...
-DGPackage=XC_Engine -Werror -I../inc -I../../Core/Inc -I../../Engine/Inc -I../../XC_Engine/Inc -I../../XC_Core/Inc -I../../CacusLib -I/usr/include/i386-linux-gnu/ \
...
strip --strip-all --discard-all ../../System/XC_Engine.so
